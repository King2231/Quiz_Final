          ...
          <main>
               <%
                    ...
                    for(Questions_Dt qd:list){
                         if(qd.getQ_no()==Integer.parseInt(request.getParameter("id"))){
               %>
               <div class="row">
                    <div class="col-md-9" style="height:350px ">     
                         Question no: <%=qd.getQ_no()%><br>
                         <%=qd.getQuestion()%><br>
                         <%=qd.getOptn1()%>
                         <%=qd.getOptn2()%>
                         <%=qd.getOptn3()%>
                    ...
                    <div class="col-md-3">
                         <div class="row">
                              <div class="col-md-12">
                                    <%if(qd.getQ_no()==1){%>    
                         <button type="submit" class="btn btn-default btn-lg" disabled> << Previous</button>   
                         <%}
                              else{%>
                         <button type="submit" class="btn btn-default btn-lg"  id="<%=qd.getQ_no()-1%>" onclick="getQ(this.id)"> << Previous</button>
                              <%}%>
                              </div>
                         </div>
                         ...
                         <div class="row">
                              <div class="col-md-12">
                                      <%if(qd.getQ_no()==list.size()){%>
                         <button type="submit" class="btn btn-default btn-lg" disabled>Next >></button>
                         <%}
                          else{%>
                         <button type="submit" class="btn btn-default btn-lg" id="<%=qd.getQ_no()+1%>" onclick="getQ(this.id)">Next >></button>
                         <%}%>
                              </div>
                         </div>
                              <div class="row">
                              <div class="col-md-12">
                                   <button type="submit" class="btn btn-default btn-lg red" id="<%=qd.getQ_no()%>" onclick="red(this.id)">Check</button>
                              </div>
                         </div>
                    </div>
               </div>
